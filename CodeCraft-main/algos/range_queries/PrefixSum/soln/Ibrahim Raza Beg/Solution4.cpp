//https://codeforces.com/problemset/submission/1843/355487762
/*
Approach: If we get a segment for the ith query then it will be there for the next queries also
So its nature is monotonic
so we can use binary search and for the middle query we will
calculate the original array after applying middle queries as operations
and for checking if a segment is good we will use prefix sum to check.
